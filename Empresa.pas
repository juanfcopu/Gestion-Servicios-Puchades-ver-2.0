...
procedure TFEmpresa.btnCerrarClick(Sender: TObject);
begin
Close;
end;
...
begin
if FDEmpresa.State in [dsInsert,dsEdit] then
if Application.MessageBox('¿Guardar los cambios de la empresa?','Guardar',MB_YESNO)=IDYES then
       begin
           FDEmpresa.Post;
       end
