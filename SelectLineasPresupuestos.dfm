object FLineasPresupuestoObra: TFLineasPresupuestoObra
  ...
  object fdqlpresupuestos: TFDQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  P.id_clientePrev, P.id_presupuesto, P.grupo, LP.Aprovado' +
        ', LP.descripcion,LP.Total,LP.id_Partida,LP.obra,P.FechaPresupues' +
        'to,LP.Fecha_Aprobado, LP.presupuestos_Id_presupuesto,LP.presupue' +
        'stos_grupo FROM lineaspresupuesto LP,presupuestos P WHERE LP.pre' +
        'supuestos_id_presupuesto=P.id_presupuesto AND LP.presupuestos_gr' +
        'upo=P.grupo AND P.id_ClientePrev=:IDCLIENTE AND LP.Aprovado=true' +
        ' AND (LP.obra is null)')
    Left = 488
    Top = 144
    ParamData = <
