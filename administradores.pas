...
procedure TFAdministradores.btn1Click(Sender: TObject);
begin
DataModule1.editarAdministradorExecute(fdadministrador);
end;
...
procedure TFAdministradores.lv1DblClick(Sender: TObject);
begin
DataModule1.VerClienteExecute(fdClientes);
end;
